...
export default function Header() {
  ...
  return (
    <HeaderFrame showBackground={scrollY > 45}>
      ...
      <Title href=".">
        <UniIcon>
          <Logo fill={darkMode ? deprecated_white : deprecated_black} width="50px" height="100%" title="SKT!Swap" />
          <HolidayOrnament />
        </UniIcon>
      </Title>
      <HeaderLinks>
        ...
        <StyledExternalLink id={`charts-nav-link`} href="https://www.geckoterminal.com/ethw/stakeget/pools">
          <Trans>Charts</Trans>
          <sup>↗</sup>
        </StyledExternalLink>
      </HeaderLinks>
