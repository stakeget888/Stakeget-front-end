...
describe('utils', () => {
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0x5cb7b6022e192Bc8DF92f8946f6Ce785216b163E')).toBe('0x5cb7b6022e192Bc8DF92f8946f6Ce785216b163E')
      expect(isAddress('0x5cb7b6022e192Bc8DF92f8946f6Ce785216b163E')).toBe('0x5cb7b6022e192Bc8DF92f8946f6Ce785216b163E')
    })

    it('succeeds even without prefix', () => {
      expect(isAddress('f164fc0ec4e93095b804a4795bbe1e041497b92a')).toBe('0x5cb7b6022e192Bc8DF92f8946f6Ce785216b163E')
    })
  ...
  describe('#shortenAddress', () => {
    ...
    it('truncates middle characters', () => {
      expect(shortenAddress('0x5cb7b6022e192Bc8DF92f8946f6Ce785216b163E')).toBe('0xf164...b92a')
    })
